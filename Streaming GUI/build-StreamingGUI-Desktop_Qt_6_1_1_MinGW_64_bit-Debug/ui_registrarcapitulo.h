/********************************************************************************
** Form generated from reading UI file 'registrarcapitulo.ui'
**
...
#ifndef UI_REGISTRARCAPITULO_H
#define UI_REGISTRARCAPITULO_H
...
public:
    ...
    void setupUi(QDialog *PeliculaRegistro)
    {
        ...
        PeliculaRegistro->resize(258, 238);
        pushButton = new QPushButton(PeliculaRegistro);
        pushButton->setObjectName(QString::fromUtf8("pushButton"));
        pushButton->setGeometry(QRect(160, 200, 80, 21));
        ...
        url->setGeometry(QRect(100, 150, 113, 21));
        ...
        LocalPath->setGeometry(QRect(220, 150, 28, 23));
